...
class TestChi2Analyzer(unittest.TestCase):
    ...
    def test_derive_entity_label_matrix(self):
        (
            ...
            labels,
            entity_avg_conf,
        ) = entity_analyzer._derive_entity_label_matrix(
            self.mock_test_result, ["entity1", "entity2"]
        )
        self.assertEqual(entity_feat_mat[1][1], 0, "test for entity analyzer fail")
        self.assertEqual(
            entity_avg_conf["entity1"], 0.75, "test for entity analyzer fail"
        )
    ...
    def test_entity_label_correlation_analysis(self):
        ...
        self.assertEqual(
            entity_label_df.iloc[0]["Correlated Entities"],
            "entity2",
